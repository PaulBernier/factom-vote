const { FactomCli } = require('factom'),
    ...
    createVote = require('../src/create-vote');
...
describe('Create vote', function () {
    ...
    it('should create a vote', async function () {
        ...
        const administrator = { id: '34704bd0fe5d8a6a7816fd5db9072580610a1b89406b3bc48b68b79c5fefb9b2', secretKey: crypto.randomBytes(32) };
        const voteData = {
            definition, registrationChainId, eligibleVoters, administrator
        };
    ...
    xit('should append eligible voters', async function () {
        this.timeout(10000);
        const administratorSecretKey = '5ac48e36b6f5884a8a8ef64d11734ff5c07e428593015d387f3284453cda3739';
        ...
        const appendEligibleVotersData = {
            eligibleVoters, eligibleVotersChainId, administratorSecretKey
        };
