...
describe('Create vote structures', function () {
    ...
    it('should generate eligible voters chain', function () {
        ...
        const chain = createVote.generateEligibleVotersChain(eligibleVoters, administrator, EC_PRIVATE_ADDRESS);
    ...
    it('should generate append eligible voters entry', function () {
        ...
        const entry = createVote.generateAppendEligibleVotersEntry(eligibleVoters, eligibleVotersChainId, administratorSecretKey, EC_PRIVATE_ADDRESS);
    ...
    it('should compose eligible voters chain', function () {
        const administrator = { id: '34704bd0fe5d8a6a7816fd5db9072580610a1b89406b3bc48b68b79c5fefb9b2', secretKey: 'fb23ef3b1ed49871e9a7710e8e3c1dc9d1f1209ffe09236c35e7f9d992020684' };
        const eligibleVoters = require('./data/eligible-voters');
        const composed = createVote.composeEligibleVotersChain(eligibleVoters, administrator, EC_PRIVATE_ADDRESS);
    ...
    it('should compose append eligible voters entry', function () {
        ...
        const eligibleVotersChainId = 'd47a9267e9677fc0fee629efa1859d7c771fce06e3f9f1a465768ac9634b7a93';
        const administratorSecretKey = 'c21782dedcf78614e4558acdd59aad4a48441d0ad8d7f61fc0849bcc79400ec5';
        const composed = createVote.composeAppendEligibleVotersEntry(eligibleVoters, eligibleVotersChainId, administratorSecretKey, EC_PRIVATE_ADDRESS);
